...
class CalculusRulesCore:
    ...
    def power_rule_calculation(self, n: float, x_vals: np.ndarray) -> Tuple[np.ndarray, np.ndarray]:
        """
    ...
    def product_rule_calculation(self, func1_str: str, func2_str: str, x_vals: np.ndarray) -> dict:
        """
    ...
    def quotient_rule_calculation(self, numerator: str, denominator: str, x_vals: np.ndarray) -> dict:
        """
    ...
    def limit_calculation(self, func_str: str, approach_point: float, x_range: Tuple[float, float]) -> dict:
        """
